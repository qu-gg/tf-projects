...
ary = np.random.uniform(0, 1, 100)
img_input = tf.cast(tf.reshape(ary, [-1, 10, 10, 1]), tf.float32)
...
net = tf.layers.conv2d_transpose(inputs=net, filters=256, kernel_size=5, padding='same', strides=2)
